...
public interface AvaliacaoDAO extends JpaRepository<Avaliacao, java.lang.String> {
   ...
   * @generated
   */
  @Query("SELECT entity FROM Avaliacao entity WHERE entity.livro.id = :id")
  public Page<Avaliacao> findAvaliacaosByLivro(@Param(value="id") java.lang.String id, Pageable pageable);
